...
@Entity
@Table(name = "assistantmanager_master")
@NamedQuery(name = "AssistantManagerMaster.findAll", query = "SELECT z FROM AssistantManagerMaster z")
public class AssistantManagerMaster implements Serializable{
